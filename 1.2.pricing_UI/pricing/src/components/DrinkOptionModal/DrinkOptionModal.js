...
class DrinkOptionModal extends React.Component {
	...
	/*
		PULL-REQUEST MODIFY SUGGESSTION:
			- You might want to check the condition:"Type hot can not go with size L" here. 
			Even though you check in getSizeAdjustment() already, 
			but customer can choose "Cold - XL" then choose type "hot".
		Or you can validate all contraint when clicking the 'Confirm' button.
	 */
	getTypeAdjustment() {
